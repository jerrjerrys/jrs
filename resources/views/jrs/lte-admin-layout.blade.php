                    ...
                    <div class="navbar-custom-menu">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="{!! asset(session('image')) !!}" class="user-image" alt="User Image"/>
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-header">
                                        ...
                                        <p>
                                            {!! session('username') !!}
                                            <small>Member since {!! session('join_at') !!}</small>
                                        </p>
                                    </li>
                                    <!-- Menu Body 
                                    <li class="user-body">
                                    ...
                                    <li class="user-footer">
                                        <div class="pull-left">
                                            <a href="{!! url('auth/update-user/'.session('id')) !!}" class="btn btn-default btn-flat">Profile</a>
                                        </div>
